/*
 * We're using Stonecutter to make releasing for multiple game versions easier. See:
 * https://stonecutter.kikugie.dev/wiki/start/builds
 * https://github.com/stonecutter-versioning/stonecutter-template-fabric/blob/main/build.gradle.kts
 */
